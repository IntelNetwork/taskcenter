...
public enum TaskBizResultEnum {
    ...
    ORDER_TO_TASK_NOT_EXISTS("005001006","该订单对应任务不存在","%s该订单对应任务不存在件"),
    TASK_NOT_CHECK("005001007","该任务已无法被审核","%s该任务已无法被审核"),
    TASK_NOT_CHECK_STATE("005001008","该任务不在被审核装态","%s该任务不在被审核装态"),
    /*****任务竞标002(中间三位)****/
