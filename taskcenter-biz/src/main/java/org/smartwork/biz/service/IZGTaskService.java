...
public interface IZGTaskService extends IService<ZGTask> {
     ...
     * @修改日期 (请填上修改该文件时的日期)
     */
    IPage<ZGTaskVo> getRelease(IPage<ZGTaskVo> page,Long memberId);
     ...
     * @修改日期 (请填上修改该文件时的日期)
     */
    IPage<ZGTaskVo> getPass(IPage<ZGTaskVo> page,Long memberId);
     ...
     * @修改日期 (请填上修改该文件时的日期)
     */
    IPage<ZGTaskVo> getCheck(IPage<ZGTaskVo> page,Long memberId);
}